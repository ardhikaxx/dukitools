...
export const metadata: Metadata = {
  title: 'Office Tools — Gratis & Tanpa Login',
  description: 'Kumpulan tools office gratis: konversi Excel, Word, dan PowerPoint online.',
};

export default function OfficeCategoryPage() {
  const category = getCategoryBySlug('office');
  const tools = getToolsByCategory('office');
