...
export const metadata: Metadata = {
  title: 'Calculator — Gratis & Tanpa Login',
  description: 'Kumpulan kalkulator gratis: BMI, persentase, konversi unit, dan lainnya.',
};

export default function CalculatorCategoryPage() {
  const category = getCategoryBySlug('calculator');
